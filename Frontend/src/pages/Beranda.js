            ...
            <div className="container"> <br></br><br></br><br></br><br></br><br></br>
                <div className="row">
                    <div className="col-6">
                        ...
                        <br></br><br></br>
                        <NavLink to='/gallery' className="btn btn-dark btn-lg w-10" type="submit">Find Your Book <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
